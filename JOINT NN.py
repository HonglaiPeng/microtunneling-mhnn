...
# =========================================================
# 3. simple NN: one output head only
# =========================================================
...
scheduler = torch.optim.lr_scheduler.Reduce LROnPlateau(
    optimizer,
    mode="min",
    factor=0.5,
    patience=10,
...
print("=" * 80)
print("Simple NN Baseline: Force-Loss Only")
print("=" * 80)
...
print("-" * 80)
print("Baseline: one NN + one output head; total-force, friction, and face losses backpropagate.")
...
print("\n" + "=" * 80)
print("TRAINING COMPLETE: SIMPLE NN FORCE-LOSS-ONLY BASELINE")
print("=" * 80)
